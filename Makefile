...
integration-tests-js: get
	...
	@echo "const _firebaseProjectId = '$(FIREBASE_PROJECT_ID)';" >> test/integration/test_config_js.env.dart
	@echo "const _firebaseApiKey = '$(FIREBASE_API_KEY)';" >> test/integration/test_config_js.env.dart
	@echo "const _allTestLimit = '$(FIREBASE_ALL_TEST_LIMIT)';" >> test/integration/test_config_js.env.dart
