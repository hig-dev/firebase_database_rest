...
class _$_Filter implements _Filter {
  const _$_Filter(final Map<String, String> filters) : _filters = filters;
  ...
  @override
  String toString() {
    return 'Filter._(filters: $filters)';
  }
...
abstract class _Filter implements Filter {
  const factory _Filter(final Map<String, String> filters) = _$_Filter;
